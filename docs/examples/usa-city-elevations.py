...
# Our first plot is a default linear-scale one. We can see from the results that this is clearly
...
# Finally, our last demo, a power scale. This is useful for data that follows a power law
# distribution of some kind. Again, this doesn't work too well in our case, but this example is
# just meant for demonstration!
