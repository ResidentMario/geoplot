...
cities = gplt.datasets.load('usa-cities')
...
gplt.polyplot(continental_usa.geometry, ax=axarr[0][0], **polyplot_kwargs)
...
gplt.polyplot(continental_usa.geometry, ax=axarr[0][1], **polyplot_kwargs)
...
gplt.polyplot(continental_usa.geometry, ax=axarr[1][0], **polyplot_kwargs)
...
gplt.polyplot(continental_usa.geometry, ax=axarr[1][1], **polyplot_kwargs)
